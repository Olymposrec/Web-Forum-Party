...
namespace Party.DataAccess
{
    ...
    public partial class ForumPartyEntities1 : DbContext
    {
        ...
        public virtual DbSet<PostCommnets> PostCommnets { get; set; }
        ...
        public virtual ObjectResult<spGetPosts_Result> spGetPosts(Nullable<int> pageNumber, Nullable<int> pageSize)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spGetPosts_Result>("spGetPosts", pageNumberParameter, pageSizeParameter);
        }
    }
}
